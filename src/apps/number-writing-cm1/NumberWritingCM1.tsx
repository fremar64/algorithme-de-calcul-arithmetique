...
const NumberWritingCM1 = () => {
  ...
  const generateNumber = () => {
    const max = 1000000;  // Numbers between 1 and 1,000,000
    const min = 1;
        ...
        <div className="flex items-center gap-4 max-w-4xl mx-auto">
          ...
          <div className="space-y-1">
            <h1 className="text-xl font-semibold text-gray-700">
              Exercice n°{questionNumber} : Écrire les nombres entiers en chiffres (CM1)
            </h1>
          </div>
        </div>
      </div>
...
export default NumberWritingCM1;
