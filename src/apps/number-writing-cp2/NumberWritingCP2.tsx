...
const NumberWritingCP2 = () => {
  ...
  const generateNumber = () => {
    const max = 100;  // Numbers between 1 and 100
    const min = 1;
        ...
        <div className="flex items-center gap-4 max-w-4xl mx-auto">
          ...
          <div className="space-y-1">
            <h1 className="text-xl font-semibold text-gray-700">
              Exercice n°{questionNumber} : Écrire les nombres entiers en chiffres (CP2)
            </h1>
          </div>
        </div>
      </div>
...
export default NumberWritingCP2;
