...
const SubtractionGame: React.FC<SubtractionGameProps> = ({ maxNumber, title }) => {
  ...
  const generateNumbers = () => {
    const top = Math.floor(Math.random() * (maxNumber - 10)) + 10;
    const bottom = Math.floor(Math.random() * (top - 1)) + 1;
      ...
      <div className="bg-gray-200 p-4 mb-6">
        <div className="flex items-center gap-4 max-w-2xl mx-auto">
          ...
          <h1 className="text-xl font-semibold text-gray-700">
            {title} n°{questionNumber} : Effectue la soustraction ci-dessous.
          </h1>
        </div>
      </div>
